...
#RUN /opt/cprocsp/bin/amd64/certmgr -inst -store root -file /tmp/cert/root.cer


RUN /opt/cprocsp/sbin/amd64/cpconfig -ini "\config\cades\trustedsites" -add multistring "TrustedSites" "https://www.cryptopro.ru/sites/default/files/products/cades/demopage/cades_bes_sample.html" "http://www.cryptopro.ru"
